...
namespace TestODataCore.Controllers
{
    ...
    public class WeatherForecastsController : ODataController
    {
        ...
        public async Task<IActionResult> Patch([FromODataUri] Guid key, Delta<WeatherForecast> weatherForecast)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        public async Task<IActionResult> Put([FromODataUri] Guid key, WeatherForecast update)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
